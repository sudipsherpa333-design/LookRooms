...
export const setupCronJobs = () => {
  ...
  cron.schedule('*/5 * * * *', async () => {
    try {
      ...
      console.error("Error in expireUnpaidFees cron job:", error);
    }
  });
  ...
  cron.schedule('*/30 * * * *', async () => {
    try {
      ...
      console.error("Error in expireLandlordResponse cron job:", error);
    }
  });
  ...
  cron.schedule('0 * * * *', async () => {
    try {
      ...
      console.error("Error in expireTenantConfirmation cron job:", error);
    }
  });
};
