...
import { AlertCircle, Eye, EyeOff, ArrowRight, Phone, Lock, ShieldCheck, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 bg-stone-900 relative items-center justify-center p-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&q=80&w=2070" 
            alt="Luxury Interior" 
        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            ...
            <h1 className="text-5xl font-black text-white leading-tight tracking-tighter mb-6">
              Find Your Next <span className="text-emerald-400">Perfect Stay</span> With Us.
            </h1>
            <p className="text-stone-300 text-lg font-medium mb-10 leading-relaxed">
              Experience the most advanced room-finding platform in Nepal. Secure, fast, and premium.
            </p>
        ...
        >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-[10px] font-black text-emerald-600 uppercase tracking-tighter hover:text-emerald-700 transition-colors"
                  >
                    Forgot Password?
                  </Link>
                </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest leading-relaxed">
              Secure Login Powered by LookRooms Advanced Security System
              <br />
              © 2026 LookRooms Nepal. All rights reserved.
            </p>
          </div>
        </motion.div>
      </div>
