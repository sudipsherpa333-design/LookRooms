...
// Fix for leaflet-draw and CDN compatibility
...
export default function ListingMap({ listings, center = [27.7172, 85.324], onSearchArea }: ListingMapProps) {
  ...
  const _onEdited = useCallback((e: any) => {
            ...
            >
              <Popup className="custom-popup" closeButton={false}>
                <Link
                  ...
                  className="block w-48 bg-white rounded-2xl overflow-hidden hover:shadow-lg transition-shadow"
                >
                  <div className="relative h-28">
                    <img
                      src={listing.images?.[0]?.url || listing.images?.[0] || "https://picsum.photos/seed/room/300/200"}
                      alt={listing.title}
                  ...
                  <div className="p-3">
                    <h4 className="font-bold text-xs text-stone-900 truncate mb-1 flex items-center gap-1">
                      {listing.title}
