  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axiosInstance.post(`/user/applications/${listingId}`, formData, {
        headers: {
          'x-user-id': localStorage.getItem('lookrooms_user') ? JSON.parse(localStorage.getItem('lookrooms_user')!).id : '',
        },
      });
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-stone-50 border border-stone-200 rounded-xl p-3 text-sm outline-none focus:ring-2 focus:ring-emerald-500 transition-all"
                placeholder="Workplace or College Name"
              />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <textarea
            ...
            placeholder="Tell the landlord about yourself and why you're interested in this LookRoom..."
          />
        </section>
